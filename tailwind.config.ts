	...
	theme: {
		...
		extend: {
			colors: {
				...
				music: {
					'primary': '#4B46A3',  // Deep purple
					'secondary': '#8E7CD8', // Lavender
					'accent': '#F86F03',    // Vibrant orange
					'light': '#F9F6FF',     // Light purple tint
					'dark': '#252139'       // Dark purple
				}
			},
			borderRadius: {
				lg: 'var(--radius)',
			...
			animation: {
				...
				'fade-in-slower': 'fade-in 1.2s ease-out',
